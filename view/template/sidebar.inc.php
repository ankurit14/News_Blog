<nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="companyView.php">
  ...
  <div class="collapse" id="userMaster">
    <ul class="nav flex-column sub-menu">
      ...
      <li class="nav-item">
        <a class="nav-link" href="userManageView.php"> Manage Users </a>
      </li>
      <li class="nav-item">
        ...
        <a class="nav-link" href="#"> User Permissions </a>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth1">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="manageDesignationView.php"> Manage Designations </a>
                  </li>
                  <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth2">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="postListView.php">Post List </a>
                  </li>
