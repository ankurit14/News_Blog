      ...
      <div class="container">
        ...
        <form method="POST" action="" id="designation">
          <div class="form-group">
            ...
            <input type="text" id="designation_name" name="designation_name" class="form-control" placeholder="Enter Designation Name" required>
             <small class="text-danger" id="designation_name_error"></small>
          </div>
          <div class="form-group">
            <label for="designation_description">Designation Description:</label>
            <textarea id="designation_description" name="designation_description" class="form-control" placeholder="Enter Designation Description" rows="4"></textarea>
        ...
        <h2 class="mt-5">Existing Designations</h2>
        <?php
