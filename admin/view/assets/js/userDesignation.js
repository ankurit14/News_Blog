...
load_table();
    ...
    $(document).ready(function() {
        const fields = [
            { id: '#designation_name', errorMsg: 'Designation Name', isPatternRequired: true },
            { id: '#designation_description', errorMsg: 'Designation Description', isPatternRequired: true },
        ];
...
// $("#designation").on("submit", function(e){
    $("#designation").on('click', '#btnSave', function(e) {
    e.preventDefault();
    // var formData = new FormData(this);
    var formData = new FormData($('#designation')[0]);
...
$("#designation").on('click', '#btnUpdate', function(e) {
    e.preventDefault();
    // var formData = new FormData(this);
    var formData = new FormData($('#designation')[0]);
