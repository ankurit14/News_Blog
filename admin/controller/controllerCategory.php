...
foreach ($Categorys as $key => $Category) {
    ...
    $table .= '<tr id="row_' . $Category['id'] . '">
                  ...
                  <td>
                    <button id="btnEdit" class="btn btn-info btn-sm" data-value ="' . $Category['id'] .'">Edit</button>
                    <button id="btnDelete" class="btn btn-danger btn-sm" data-value ="' . $Category['id'] .'">Delete</button>
                  </td>
                </tr>';
}
